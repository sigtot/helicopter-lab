  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p2_DW.ToFile8_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_DW.ToFile9_PWORK.FilePtr
	  ...
	  ;% P4p2_DW.ToFile8_IWORK.Count
	  section.data(1).logicalSrcIdx = 33;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_DW.ToFile9_IWORK.Count
  ...
  targMap.checksum0 = 2807221956;
  targMap.checksum1 = 139382411;
  targMap.checksum2 = 3812007290;
  targMap.checksum3 = 2720729584;
