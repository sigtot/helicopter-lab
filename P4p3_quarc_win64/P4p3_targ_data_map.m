  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p3_DW.ToFile8_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p3_DW.ToFile9_PWORK.FilePtr
	  ...
	  ;% P4p3_DW.ToFile8_IWORK.Count
	  section.data(1).logicalSrcIdx = 33;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p3_DW.ToFile9_IWORK.Count
  ...
  targMap.checksum0 = 4075482423;
  targMap.checksum1 = 4294509391;
  targMap.checksum2 = 2688468672;
  targMap.checksum3 = 2814994693;
