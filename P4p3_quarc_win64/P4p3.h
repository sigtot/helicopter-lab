...
struct P_P4p3_T_ {
  ...
  real_T B_observer[12];               /* Variable: B_observer
                                        * Referenced by: '<S3>/B'
                                        */
  real_T C_observer_p3[12];            /* Variable: C_observer_p3
                                        * Referenced by:
                                        *   '<Root>/C_observer_p3'
                                        *   '<S3>/C'
                                        */
 ...
 * '<S5>'   : 'P4p3/Joystick'
 * '<S6>'   : 'P4p3/LQR'
 * '<S7>'   : 'P4p3/Radians to Degrees4'
 * '<S8>'   : 'P4p3/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'P4p3/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'P4p3/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'P4p3/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'P4p3/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'P4p3/Heli 3D/Travel rate  rad to deg'
 */
