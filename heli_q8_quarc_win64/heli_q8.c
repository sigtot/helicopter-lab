 ...
 * C source code generated on : Tue Sep 11 11:29:37 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      unnamed_idx_1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      unnamed_idx_1 = 0.0;
    } else {
      unnamed_idx_1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S7>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * unnamed_idx_1 *
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      unnamed_idx_1 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      unnamed_idx_1 = 0.0;
    } else {
      unnamed_idx_1 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S7>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * unnamed_idx_1 *
    ...
    /* Gain: '<S2>/Gain1' */
    heli_q8_B.Gain1_j = heli_q8_P.Gain1_Gain * heli_q8_B.Gain;
  }
   ...
   *  Gain: '<S4>/Gain1'
   */
  unnamed_idx_1 = heli_q8_P.Gain1_Gain_e * heli_q8_B.Gain_b;
  unnamed_idx_2 = heli_q8_P.Gain1_Gain_i * heli_q8_B.Gain_d;
   ...
   */
  for (i = 0; i < 2; i++) {
    heli_q8_B.Substract[i] = heli_q8_B.Gain1[i] - ((heli_q8_P.K[i + 2] *
      unnamed_idx_1 + heli_q8_P.K[i] * heli_q8_B.Gain1_j) + heli_q8_P.K[i + 4] *
      unnamed_idx_2);
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<S11>/Gain'
     */
    heli_q8_B.Sum = heli_q8_P.Gain_Gain_l * heli_q8_B.ElevationCounttorad +
      heli_q8_P.elevation_offset;
   ...
   *  Sum: '<S1>/Add'
   */
  unnamed_idx_1 = (heli_q8_B.Substract[1] + heli_q8_B.Substract[0]) *
    heli_q8_P.Frontgain_Gain;

  /* Saturate: '<S6>/Front motor: Saturation' */
  if (unnamed_idx_1 > heli_q8_P.FrontmotorSaturation_UpperSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_UpperSat;
  } else if (unnamed_idx_1 < heli_q8_P.FrontmotorSaturation_LowerSat) {
    heli_q8_B.FrontmotorSaturation = heli_q8_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q8_B.FrontmotorSaturation = unnamed_idx_1;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  unnamed_idx_1 = (heli_q8_B.Substract[0] - heli_q8_B.Substract[1]) *
    heli_q8_P.Backgain_Gain;

  /* Saturate: '<S6>/Back motor: Saturation' */
  if (unnamed_idx_1 > heli_q8_P.BackmotorSaturation_UpperSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_UpperSat;
  } else if (unnamed_idx_1 < heli_q8_P.BackmotorSaturation_LowerSat) {
    heli_q8_B.BackmotorSaturation = heli_q8_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q8_B.BackmotorSaturation = unnamed_idx_1;
  }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (877038307U);
  heli_q8_M->Sizes.checksums[1] = (123844359U);
  heli_q8_M->Sizes.checksums[2] = (3937560680U);
  heli_q8_M->Sizes.checksums[3] = (3513684450U);
...

  {
    ...
    heli_q8_B.Substract[0] = 0.0;
    heli_q8_B.Substract[1] = 0.0;
    heli_q8_B.Sum = 0.0;
