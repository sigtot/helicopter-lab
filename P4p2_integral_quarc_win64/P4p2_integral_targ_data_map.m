  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p2_integral_P.A_observer
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_integral_P.B_observer
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 36;
	
	  ;% P4p2_integral_P.C_observer_p2
	  ...
	  ;% P4p2_integral_P.Integrator_IC_k
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p2_integral_B.Vs_astrix
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 21;
	
	  ;% P4p2_integral_B.Sum_a
	  section.data(17).logicalSrcIdx = 16;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p2_integral_DW.ToFile8_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_integral_DW.ToFile9_PWORK.FilePtr
	  ...
	  ;% P4p2_integral_DW.ToFile8_IWORK.Count
	  section.data(1).logicalSrcIdx = 33;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_integral_DW.ToFile9_IWORK.Count
  ...
  targMap.checksum0 = 1684516995;
  targMap.checksum1 = 1006567536;
  targMap.checksum2 = 3949613504;
  targMap.checksum3 = 392441816;
