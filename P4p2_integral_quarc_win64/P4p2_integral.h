...
typedef struct {
  ...
  real_T Gain1[2];                     /* '<S6>/Gain1' */
  real_T Vs_astrix;                    /* '<Root>/Vs_astrix' */
  real_T Sum_a[6];                     /* '<S3>/Sum' */
...
struct P_P4p2_integral_T_ {
  ...
  real_T B_observer[12];               /* Variable: B_observer
                                        * Referenced by: '<S3>/B'
                                        */
  real_T C_observer_p2[18];            /* Variable: C_observer_p2
                                        * Referenced by:
                                        *   '<Root>/C_observer_p2'
                                        *   '<S3>/C'
                                        */
  ...
  real_T P[4];                         /* Variable: P
                                        ...
                                        */
  real_T Vs_astrix;                    /* Variable: Vs_astrix
 ...
 * '<S3>'   : 'P4p2_integral/Estimators'
 * '<S4>'   : 'P4p2_integral/Heli 3D'
 * '<S5>'   : 'P4p2_integral/Joystick'
 * '<S6>'   : 'P4p2_integral/LQR'
 * '<S7>'   : 'P4p2_integral/Radians to Degrees4'
 * '<S8>'   : 'P4p2_integral/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'P4p2_integral/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'P4p2_integral/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'P4p2_integral/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'P4p2_integral/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'P4p2_integral/Heli 3D/Travel rate  rad to deg'
 */
