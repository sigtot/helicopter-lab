 ...
 * C source code generated on : Sat Oct 20 01:10:14 2018
 *
...
void P4p2_integral_output0(void)       /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  for (i = 0; i < 6; i++) {
    P4p2_integral_B.Gain[i] = P4p2_integral_P.Gain_Gain *
      P4p2_integral_X.Integrator_CSTATE[i];
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    if (rtmIsMajorTimeStep(P4p2_integral_M)) {
      {
        if (!(++P4p2_integral_DW.ToFile8_IWORK.Decimation % 1) &&
            (P4p2_integral_DW.ToFile8_IWORK.Count*7)+1 < 100000000 ) {
          FILE *fp = (FILE *) P4p2_integral_DW.ToFile8_PWORK.FilePtr;
          if (fp != (NULL)) {
            real_T u[7];
            P4p2_integral_DW.ToFile8_IWORK.Decimation = 0;
            u[0] = P4p2_integral_M->Timing.t[1];
            u[1] = P4p2_integral_B.Gain[0];
            u[2] = P4p2_integral_B.Gain[1];
            u[3] = P4p2_integral_B.Gain[2];
            u[4] = P4p2_integral_B.Gain[3];
            u[5] = P4p2_integral_B.Gain[4];
            u[6] = P4p2_integral_B.Gain[5];
            ...
            if (((++P4p2_integral_DW.ToFile8_IWORK.Count)*7)+1 >= 100000000) {
              (void)fprintf(stdout,
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     *  Gain: '<S8>/Gain'
     */
    P4p2_integral_B.Sum = P4p2_integral_P.Gain_Gain_l *
      P4p2_integral_B.ElevationCounttorad + P4p2_integral_P.elevation_offset;
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[0] = P4p2_integral_B.Gain_i;
    rtb_TmpSignalConversionAtToFile[1] = P4p2_integral_B.Gain_b;
    rtb_TmpSignalConversionAtToFile[2] = P4p2_integral_B.Sum;
    rtb_TmpSignalConversionAtToFile[3] = P4p2_integral_B.Gain_d;
    rtb_TmpSignalConversionAtToFile[4] = P4p2_integral_B.Gain_p;
    rtb_TmpSignalConversionAtToFile[5] = P4p2_integral_B.Gain_dc;

    /* ToFile: '<Root>/To File9' */
    if (rtmIsMajorTimeStep(P4p2_integral_M)) {
      {
        if (!(++P4p2_integral_DW.ToFile9_IWORK.Decimation % 1) &&
            (P4p2_integral_DW.ToFile9_IWORK.Count*7)+1 < 100000000 ) {
          FILE *fp = (FILE *) P4p2_integral_DW.ToFile9_PWORK.FilePtr;
          if (fp != (NULL)) {
            real_T u[7];
            P4p2_integral_DW.ToFile9_IWORK.Decimation = 0;
            u[0] = P4p2_integral_M->Timing.t[1];
            ...
            if (((++P4p2_integral_DW.ToFile9_IWORK.Count)*7)+1 >= 100000000) {
              (void)fprintf(stdout,
                            "*** The ToFile block will stop logging data before\n"
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     */
    P4p2_integral_B.Gain1[0] = 0.0;
    P4p2_integral_B.Gain1[0] += P4p2_integral_P.P[0] *
      P4p2_integral_B.Joystick_gain_x;
    P4p2_integral_B.Gain1[0] += P4p2_integral_P.P[2] *
      P4p2_integral_B.Joystick_gain_y;
    P4p2_integral_B.Gain1[1] = 0.0;
    P4p2_integral_B.Gain1[1] += P4p2_integral_P.P[1] *
      P4p2_integral_B.Joystick_gain_x;
    P4p2_integral_B.Gain1[1] += P4p2_integral_P.P[3] *
      P4p2_integral_B.Joystick_gain_y;
  }

  /* End of RateTransition: '<S5>/Rate Transition: x' */

  /* SignalConversion: '<S6>/TmpSignal ConversionAtGain2Inport1' incorporates:
   *  Gain: '<S6>/Gain2'
   *  Integrator: '<S3>/Integrator'
   *  Integrator: '<S6>/Integrator'
   *  Integrator: '<S6>/Integrator1'
   */
  tmp[0] = P4p2_integral_X.Integrator_CSTATE[0];
  tmp[1] = P4p2_integral_X.Integrator_CSTATE[1];
  tmp[2] = P4p2_integral_X.Integrator_CSTATE[3];
  tmp[3] = P4p2_integral_X.Integrator_CSTATE_n;
  ...
  for (i = 0; i < 2; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      u0 += P4p2_integral_P.K_w_integral[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_Substract[i] = P4p2_integral_B.Gain1[i] - u0;
  }

  /* End of Sum: '<S6>/Substract' */
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* Constant: '<Root>/Vs_astrix' */
    P4p2_integral_B.Vs_astrix = P4p2_integral_P.Vs_astrix;
  }

  /* Sum: '<Root>/Sum2' */
  rtb_Frontgain = rtb_Substract[0] + P4p2_integral_B.Vs_astrix;

  /* SignalConversion: '<Root>/TmpSignal ConversionAtC_observer_p2Inport1' */
  tmp_0[0] = P4p2_integral_B.Gain_i;
  tmp_0[1] = P4p2_integral_B.Gain_b;
  tmp_0[2] = P4p2_integral_B.Sum;
  tmp_0[3] = P4p2_integral_B.Gain_d;
  tmp_0[4] = P4p2_integral_B.Gain_p;
  tmp_0[5] = P4p2_integral_B.Gain_dc;
  ...
  for (i = 0; i < 3; i++) {
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_1[i] += P4p2_integral_P.C_observer_p2[3 * i_0 + i] * tmp_0[i_0];
    }
  }
  ...
  for (i = 0; i < 3; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      u0 += P4p2_integral_P.C_observer_p2[3 * i_0 + i] *
        P4p2_integral_X.Integrator_CSTATE[i_0];
    }

    tmp_2[i] = P4p2_integral_P.Gain1_Gain * tmp_1[i] - u0;
  }
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Sum: '<S3>/Sum'
     */
    tmp_0[i] = P4p2_integral_P.L[i + 12] * tmp_2[2] + (P4p2_integral_P.L[i + 6] *
      tmp_2[1] + P4p2_integral_P.L[i] * tmp_2[0]);

    /* Gain: '<S3>/B' incorporates:
     *  Sum: '<S3>/Sum'
     */
    tmp_3[i] = P4p2_integral_P.B_observer[i + 6] * rtb_Substract[1] +
      P4p2_integral_P.B_observer[i] * rtb_Substract[0];
  }
  ...
  for (i = 0; i < 6; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      u0 += P4p2_integral_P.A_observer[6 * i_0 + i] *
        P4p2_integral_X.Integrator_CSTATE[i_0];
    }

    P4p2_integral_B.Sum_a[i] = (tmp_0[i] + tmp_3[i]) + u0;
  }
   ...
   *  Sum: '<S2>/Add'
   */
  u0 = (rtb_Substract[1] + rtb_Frontgain) * P4p2_integral_P.Frontgain_Gain;
   ...
   *  Sum: '<S2>/Subtract'
   */
  u0 = (rtb_Frontgain - rtb_Substract[1]) * P4p2_integral_P.Backgain_Gain;
   ...
   *  Integrator: '<S3>/Integrator'
   */
  P4p2_integral_B.Sum_p = P4p2_integral_X.Integrator_CSTATE[0] -
    P4p2_integral_B.Joystick_gain_x;

  /* Sum: '<S6>/Sum1' incorporates:
   *  Integrator: '<S3>/Integrator'
   */
  P4p2_integral_B.Sum1 = P4p2_integral_X.Integrator_CSTATE[3] -
    P4p2_integral_B.Joystick_gain_y;
}
...
void P4p2_integral_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator_CSTATE[i] = P4p2_integral_B.Sum_a[i];
  }
  ...
  _rtXdot->Integrator_CSTATE_n = P4p2_integral_B.Sum_p;

  /* Derivatives for Integrator: '<S6>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = P4p2_integral_B.Sum1;
}
...
void P4p2_integral_initialize(void)
{
  ...
  /* Start for ToFile: '<Root>/To File8' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file estimates.mat");
      return;
    }
    ...
    P4p2_integral_DW.ToFile8_IWORK.Count = 0;
    P4p2_integral_DW.ToFile8_IWORK.Decimation = -1;
    P4p2_integral_DW.ToFile8_PWORK.FilePtr = fp;
  }
  ...
  /* Start for ToFile: '<Root>/To File9' */
  {
    ...
    P4p2_integral_DW.ToFile9_IWORK.Count = 0;
    P4p2_integral_DW.ToFile9_IWORK.Decimation = -1;
    P4p2_integral_DW.ToFile9_PWORK.FilePtr = fp;
  }
...

  {
    ...
    P4p2_integral_X.Integrator_CSTATE_n = P4p2_integral_P.Integrator_IC_k;
...
void P4p2_integral_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File8' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file estimates.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file estimates.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, P4p2_integral_DW.ToFile8_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(P4p2_integral_M,
      ...
      P4p2_integral_DW.ToFile8_PWORK.FilePtr = (NULL);
    }
  }
  ...
  /* Terminate for ToFile: '<Root>/To File9' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (rt_WriteMat4FileHeader(fp, 7, P4p2_integral_DW.ToFile9_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(P4p2_integral_M,
      ...
      P4p2_integral_DW.ToFile9_PWORK.FilePtr = (NULL);
    }
  }
...
RT_MODEL_P4p2_integral_T *P4p2_integral(void)
{
  ...
  /* External mode info */
  P4p2_integral_M->Sizes.checksums[0] = (1684516995U);
  P4p2_integral_M->Sizes.checksums[1] = (1006567536U);
  P4p2_integral_M->Sizes.checksums[2] = (3949613504U);
  P4p2_integral_M->Sizes.checksums[3] = (392441816U);
...

  {
    int_T i;
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Gain[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Sum_a[i] = 0.0;
    }
  ...
  P4p2_integral_M->Sizes.numBlocks = (65);/* Number of blocks */
  P4p2_integral_M->Sizes.numBlockIO = (23);/* Number of block outputs */
  P4p2_integral_M->Sizes.numBlockPrms = (246);/* Sum of parameter "widths" */
