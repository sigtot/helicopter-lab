 ...
 * C source code generated on : Sun Oct 14 18:38:04 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Sum: '<Root>/Sum' */
  P2p1_B.Sum = P2p1_B.Step + P2p1_B.Gain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* ToFile: '<Root>/To File' */
    if (rtmIsMajorTimeStep(P2p1_M)) {
      {
   ...
   *  Sum: '<S7>/Sum'
   */
  rtb_Backgain = (P2p1_B.Joystick_gain_x - P2p1_P.Gain1_Gain * P2p1_B.Sum) *
    P2p1_P.K_pp - P2p1_P.Gain1_Gain_d * P2p1_B.Gain_b * P2p1_P.K_pd;
  if (rtmIsMajorTimeStep(P2p1_M)) {
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
     ...
     *  Gain: '<S9>/Gain'
     */
    P2p1_B.Sum_p = P2p1_P.Gain_Gain_l * P2p1_B.ElevationCounttorad +
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (685542428U);
  P2p1_M->Sizes.checksums[1] = (1961280542U);
  P2p1_M->Sizes.checksums[2] = (585949708U);
  P2p1_M->Sizes.checksums[3] = (4235163407U);
  ...
  P2p1_M->Sizes.numBlocks = (54);      /* Number of blocks */
