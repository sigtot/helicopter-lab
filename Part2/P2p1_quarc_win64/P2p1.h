 ...
 * '<S2>'   : 'P2p1/...1'
 * '<S3>'   : 'P2p1/Conversion'
 * '<S4>'   : 'P2p1/Elevation controller'
 * '<S5>'   : 'P2p1/Heli 3D'
 * '<S6>'   : 'P2p1/Joystick'
 * '<S7>'   : 'P2p1/Pitch controller'
 * '<S8>'   : 'P2p1/Elevation controller/Elevation controller'
 * '<S9>'   : 'P2p1/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'P2p1/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'P2p1/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'P2p1/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'P2p1/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'P2p1/Heli 3D/Travel rate  rad to deg'
 */
