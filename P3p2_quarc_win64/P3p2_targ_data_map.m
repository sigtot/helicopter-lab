  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P3p2_P.PulseGenerator_Amp
	  section.data(1).logicalSrcIdx = 73;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P3p2_P.PulseGenerator_Period
	  section.data(2).logicalSrcIdx = 74;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P3p2_P.PulseGenerator_Duty
	  section.data(3).logicalSrcIdx = 75;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P3p2_P.PulseGenerator_PhaseDelay
	  section.data(4).logicalSrcIdx = 76;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P3p2_P.PulseGenerator1_Amp
	  section.data(5).logicalSrcIdx = 77;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P3p2_P.PulseGenerator1_Period
	  section.data(6).logicalSrcIdx = 78;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P3p2_P.PulseGenerator1_Duty
	  section.data(7).logicalSrcIdx = 79;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P3p2_P.PulseGenerator1_PhaseDelay
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P3p2_DW.ToFile2_PWORK.FilePtr
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P3p2_DW.ToFile3_PWORK.FilePtr
	  ...
	  ;% P3p2_DW.ToFile2_IWORK.Count
	  section.data(3).logicalSrcIdx = 39;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P3p2_DW.ToFile3_IWORK.Count
  ...
  targMap.checksum0 = 2667712320;
  targMap.checksum1 = 1926583265;
  targMap.checksum2 = 3692195470;
  targMap.checksum3 = 2709047371;
