...
MODEL                = P3p2_integral
MODULES              = P3p2_integral_data.c P3p2_integral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P3p2_integral.mk
...
MODELLIB                  = P3p2_integrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P3p2_integral_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P3p2_integral_quarc_win64
