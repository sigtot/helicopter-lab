 ...
 */
#ifndef RTW_HEADER_P3p2_integral_h_
#define RTW_HEADER_P3p2_integral_h_
#include <stddef.h>
#include <string.h>
#ifndef P3p2_integral_COMMON_INCLUDES_
# define P3p2_integral_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P3p2_integral_COMMON_INCLUDES_ */

#include "P3p2_integral_types.h"
...
#define P3p2_integral_rtModel          RT_MODEL_P3p2_integral_T
...
typedef struct {
  ...
  int32_T clockTickCounter_h;          /* '<Root>/Pulse Generator1' */
...
#define rtB                            P3p2_integral_B
#define BlockIO                        B_P3p2_integral_T
#define rtX                            P3p2_integral_X
#define ContinuousStates               X_P3p2_integral_T
#define rtXdot                         P3p2_integral_XDot
#define StateDerivatives               XDot_P3p2_integral_T
#define tXdis                          P3p2_integral_XDis
#define StateDisabled                  XDis_P3p2_integral_T
#define rtP                            P3p2_integral_P
#define Parameters                     P_P3p2_integral_T
#define rtDWork                        P3p2_integral_DW
#define D_Work                         DW_P3p2_integral_T

/* Parameters (auto storage) */
struct P_P3p2_integral_T_ {
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K_w_integral[10];             /* Variable: K_w_integral
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T PulseGenerator_Amp;           /* Expression: 30
  ...
  real_T PulseGenerator_PhaseDelay;    /* Expression: 0
                                        * Referenced by: '<Root>/Pulse Generator'
                                        */
  real_T PulseGenerator1_Amp;          /* Expression: 6
  ...
  real_T Backgain_Gain;                /* Expression: 0.5
                                        * Referenced by: '<S6>/Back gain'
                                        */
  real_T Frontgain_Gain;               /* Expression: 0.5
                                        * Referenced by: '<S6>/Front gain'
                                        */
...
struct tag_RTM_P3p2_integral_T {
  const char_T *path;
...
extern P_P3p2_integral_T P3p2_integral_P;

/* Block signals (auto storage) */
extern B_P3p2_integral_T P3p2_integral_B;

/* Continuous states (auto storage) */
extern X_P3p2_integral_T P3p2_integral_X;

/* Block states (auto storage) */
extern DW_P3p2_integral_T P3p2_integral_DW;
...
extern void P3p2_integral_initialize(void);
extern void P3p2_integral_output0(void);
extern void P3p2_integral_update0(void);
extern void P3p2_integral_output(int_T tid);
extern void P3p2_integral_update(int_T tid);
extern void P3p2_integral_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P3p2_integral_T *const P3p2_integral_M;
 ...
 * '<S4>'   : 'P3p2_integral/.1'
 * '<S5>'   : 'P3p2_integral/.2'
 * '<S6>'   : 'P3p2_integral/Conversion'
 * '<S7>'   : 'P3p2_integral/Heli 3D'
 * '<S8>'   : 'P3p2_integral/Joystick'
 * '<S9>'   : 'P3p2_integral/LQR'
 * '<S10>'  : 'P3p2_integral/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'P3p2_integral/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'P3p2_integral/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'P3p2_integral/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'P3p2_integral/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'P3p2_integral/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P3p2_integral_h_ */
