 ...
 * C source code generated on : Sat Oct 20 01:07:34 2018
 *
...
void P3p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    if (P3p3_B.RateTransitionx > P3p3_P.DeadZonex_End) {
      rtb_Backgain = P3p3_B.RateTransitionx - P3p3_P.DeadZonex_End;
    } else if (P3p3_B.RateTransitionx >= P3p3_P.DeadZonex_Start) {
      rtb_Backgain = 0.0;
    } else {
      rtb_Backgain = P3p3_B.RateTransitionx - P3p3_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S6>/Gain: x'
     */
    P3p3_B.Joystick_gain_x = P3p3_P.Gainx_Gain * rtb_Backgain *
    ...
    rtb_TmpSignalConversionAtGain1I[0] = P3p3_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtGain1I[1] = P3p3_B.Joystick_gain_y;

    /* Gain: '<S8>/Gain' incorporates:
     *  SignalConversion: '<S7>/TmpSignal ConversionAtGain1Inport1'
     */
    rtb_Gain_a[0] = P3p3_P.Gain_Gain * P3p3_B.Joystick_gain_x;
    rtb_Gain_a[1] = P3p3_P.Gain_Gain * P3p3_B.Joystick_gain_y;
    ...
    /* Gain: '<S11>/Gain' */
    P3p3_B.Gain = P3p3_P.Gain_Gain_a * P3p3_B.PitchCounttorad;
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
     ...
     *  Gain: '<S9>/Gain'
     */
    P3p3_B.Sum = P3p3_P.Gain_Gain_l * P3p3_B.ElevationCounttorad +
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[1] = P3p3_B.Gain_b;
    rtb_TmpSignalConversionAtToFile[2] = P3p3_B.Sum;
    rtb_TmpSignalConversionAtToFile[3] = P3p3_B.Gain_d;
    rtb_TmpSignalConversionAtToFile[4] = P3p3_B.Gain_p;
    rtb_TmpSignalConversionAtToFile[5] = P3p3_B.Gain_dc;

    /* ToFile: '<Root>/To File9' */
    if (rtmIsMajorTimeStep(P3p3_M)) {
      {
        if (!(++P3p3_DW.ToFile9_IWORK.Decimation % 1) &&
            (P3p3_DW.ToFile9_IWORK.Count*7)+1 < 100000000 ) {
          FILE *fp = (FILE *) P3p3_DW.ToFile9_PWORK.FilePtr;
          if (fp != (NULL)) {
            real_T u[7];
            P3p3_DW.ToFile9_IWORK.Decimation = 0;
            u[0] = P3p3_M->Timing.t[1];
            ...
            if (((++P3p3_DW.ToFile9_IWORK.Count)*7)+1 >= 100000000) {
              (void)fprintf(stdout,
                            "*** The ToFile block will stop logging data before\n"
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
    ...
    /* Gain: '<S1>/Gain1' */
    P3p3_B.Gain1 = P3p3_P.Gain1_Gain * P3p3_B.Gain;
  }

  /* Gain: '<S2>/Gain1' */
  rtb_Gain1_d = P3p3_P.Gain1_Gain_b * P3p3_B.Gain_d;
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* Gain: '<S7>/Gain1' */
    P3p3_B.Gain1_e[0] = 0.0;
    P3p3_B.Gain1_e[0] += P3p3_P.P[0] * rtb_TmpSignalConversionAtGain1I[0];
    P3p3_B.Gain1_e[0] += P3p3_P.P[2] * rtb_TmpSignalConversionAtGain1I[1];
    P3p3_B.Gain1_e[1] = 0.0;
    P3p3_B.Gain1_e[1] += P3p3_P.P[1] * rtb_TmpSignalConversionAtGain1I[0];
    P3p3_B.Gain1_e[1] += P3p3_P.P[3] * rtb_TmpSignalConversionAtGain1I[1];
  }
   ...
   */
  tmp[0] = P3p3_B.Gain1;
  tmp[1] = P3p3_P.Gain1_Gain_f * P3p3_B.Gain_b;
  tmp[2] = rtb_Gain1_d;
  tmp[3] = P3p3_X.Integrator1_CSTATE;
  tmp[4] = P3p3_X.Integrator_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Backgain = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Backgain += P3p3_P.K_w_integral[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_TmpSignalConversionAtGain1I[i] = P3p3_B.Gain1_e[i] - rtb_Backgain;
  }

  /* End of Sum: '<S7>/Substract' */
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* Constant: '<Root>/Vs_asterix' */
    P3p3_B.Vs_asterix = P3p3_P.Vs_astrix;
  }

  /* Sum: '<Root>/Sum2' */
  rtb_Backgain = rtb_TmpSignalConversionAtGain1I[0] + P3p3_B.Vs_asterix;
  if (rtmIsMajorTimeStep(P3p3_M)) {
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    /* Sum: '<S7>/Sum' */
    P3p3_B.Sum_i = P3p3_B.Gain1 - P3p3_B.Joystick_gain_x;
  }

  /* Sum: '<S7>/Sum1' */
  P3p3_B.Sum1 = rtb_Gain1_d - P3p3_B.Joystick_gain_y;
}
...
void P3p3_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = P3p3_B.Sum_i;
...
void P3p3_initialize(void)
{
  ...
  /* Start for ToFile: '<Root>/To File1' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P3p3_M, "Error creating .mat file references.mat");
      return;
    }
  ...
  /* Start for ToFile: '<Root>/To File9' */
  {
    ...
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P3p3_M, "Error creating .mat file measurements.mat");
      return;
    }
    ...
    P3p3_DW.ToFile9_IWORK.Count = 0;
    P3p3_DW.ToFile9_IWORK.Decimation = -1;
    P3p3_DW.ToFile9_PWORK.FilePtr = fp;
  }
...
void P3p3_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "references.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P3p3_M, "Error closing MAT-file references.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P3p3_M, "Error reopening MAT-file references.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 3, P3p3_DW.ToFile1_IWORK.Count, "data")) {
        rtmSetErrorStatus(P3p3_M,
  ...
  /* Terminate for ToFile: '<Root>/To File9' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "measurements.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P3p3_M, "Error closing MAT-file measurements.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P3p3_M, "Error reopening MAT-file measurements.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, P3p3_DW.ToFile9_IWORK.Count, "data")) {
        rtmSetErrorStatus(P3p3_M,
      ...
      P3p3_DW.ToFile9_PWORK.FilePtr = (NULL);
    }
  }
...
RT_MODEL_P3p3_T *P3p3(void)
{
  ...
  /* External mode info */
  P3p3_M->Sizes.checksums[0] = (2464339813U);
  P3p3_M->Sizes.checksums[1] = (283685101U);
  P3p3_M->Sizes.checksums[2] = (2611823126U);
  P3p3_M->Sizes.checksums[3] = (3631023597U);
  ...
  P3p3_M->Sizes.numBlocks = (58);      /* Number of blocks */
  P3p3_M->Sizes.numBlockIO = (22);     /* Number of block outputs */
