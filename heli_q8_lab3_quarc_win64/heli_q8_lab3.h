...
typedef struct {
  ...
  real_T Gain_i;                       /* '<S15>/Gain' */
  real_T Gain1[3];                     /* '<S4>/Gain1' */
  real_T Integrator[6];                /* '<S7>/Integrator' */
  ...
  real_T Gain1_e[2];                   /* '<S10>/Gain1' */
  real_T Sum_a[6];                     /* '<S7>/Sum' */
  ...
  real_T Sum_l;                        /* '<S10>/Sum' */
  real_T Sum1_o;                       /* '<S10>/Sum1' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE[6];         /* '<S7>/Integrator' */
  real_T gamma_CSTATE;                 /* '<S10>/gamma' */
  real_T delta_CSTATE;                 /* '<S10>/delta' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE[6];      /* '<S7>/Integrator' */
  boolean_T gamma_CSTATE;              /* '<S10>/gamma' */
  boolean_T delta_CSTATE;              /* '<S10>/delta' */
...
struct P_heli_q8_lab3_T_ {
  real_T A_observer[36];               /* Variable: A_observer
                                        * Referenced by: '<S7>/A'
                                        */
  real_T B_observer[12];               /* Variable: B_observer
                                        * Referenced by: '<S7>/B'
                                        */
  real_T C_observer[18];               /* Variable: C_observer
                                        * Referenced by: '<S7>/C'
                                        */
  ...
  real_T TravelCounttorad_Gain;        /* Expression: 2*pi/8192
                                        ...
                                        */
  real_T Gain_Gain_arf;                /* Expression: 180/pi
                                        * Referenced by: '<S17>/Gain'
                                        */
  real_T Gain1_Gain_f;                 /* Expression: pi/180
                                        * Referenced by: '<S3>/Gain1'
                                        */
  real_T PulseGenerator_Amp;           /* Expression: 0.7
 ...
 * '<S3>'   : 'heli_q8_lab3/...'
 * '<S4>'   : 'heli_q8_lab3/...1'
 * '<S5>'   : 'heli_q8_lab3/Conversion'
 * '<S6>'   : 'heli_q8_lab3/Elevation controller'
 * '<S7>'   : 'heli_q8_lab3/Estimators'
 * '<S8>'   : 'heli_q8_lab3/Heli 3D'
 * '<S9>'   : 'heli_q8_lab3/Joystick'
 * '<S10>'  : 'heli_q8_lab3/LQR'
 * '<S11>'  : 'heli_q8_lab3/Pitch controller'
 * '<S12>'  : 'heli_q8_lab3/Elevation controller/Elevation controller'
 * '<S13>'  : 'heli_q8_lab3/Heli 3D/Elevation rad to deg'
 * '<S14>'  : 'heli_q8_lab3/Heli 3D/Elevation rate rad to deg'
 * '<S15>'  : 'heli_q8_lab3/Heli 3D/Pitch rad to deg'
 * '<S16>'  : 'heli_q8_lab3/Heli 3D/Pitch rate rad to deg'
 * '<S17>'  : 'heli_q8_lab3/Heli 3D/Travel rad to deg'
 * '<S18>'  : 'heli_q8_lab3/Heli 3D/Travel rate  rad to deg'
 */
